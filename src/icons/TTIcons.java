...
public interface TTIcons {
	...
	@NotNull Icon AGDA_CORE_FILE = IconLoader.getIcon("/icons/mtt/mtt_file.svg");
	@NotNull Icon AGDA_CORE = AGDA_CORE_FILE;
	// TODO: this is a placeholder
	@NotNull Icon M_LANG_FILE = AGDA_CORE_FILE;
	@NotNull Icon M_LANG = AGDA_CORE_FILE;
	@NotNull Icon MLPOLYR_FILE = IconLoader.getIcon("/icons/mlpr/mlpr_file.svg");
	@NotNull Icon MLPOLYR = MLPOLYR_FILE;
	@NotNull Icon CUBICAL_TT_FILE = IconLoader.getIcon("/icons/ctt/ctt_file.svg");
	@NotNull Icon CUBICAL_TT = CUBICAL_TT_FILE;
	@NotNull Icon YACC_TT_FILE = IconLoader.getIcon("/icons/ytt/ytt_file.svg");
